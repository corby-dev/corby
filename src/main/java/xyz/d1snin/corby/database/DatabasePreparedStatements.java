...
public class DatabasePreparedStatements {
  ...
  public static void loadAllPreparedStatements() {
    ...
    try {
      ...
      Corby.logger.error(
          "Error while trying to load all prepared statements of the database. Stacktrace:");
      e.printStackTrace();
    }
  }
  ...
  public static void closeAllPreparedStatements() {
    try {
      ...
      Corby.logger.error(
          "Something went wrong while trying to close all prepared statements. Stacktrace:");
      e.printStackTrace();
    }
  }
